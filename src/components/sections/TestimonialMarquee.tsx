...
const testimonials = [
  {
    quote: "Склад 800 м², от фундамента до благоустройства за 5 месяцев. Смета не изменилась ни на рубль — как зафиксировали, так и закрыли.",
    author: "Андрей К.",
    role: "Руководитель складского комплекса, Усть-Кинельский",
  },
  {
    quote: "Аварийное состояние перекрытий, работа без подъёмной техники — другие отказали, ПромСтрой взялся и сделал. Объект сохранили.",
    author: "Марина В.",
    role: "Собственник объекта на ул. Венцека",
  },
  {
    quote: "Один подрядчик закрыл всё: каркас, кровлю, сети, отделку, территорию. Мне не пришлось нанимать ещё кого-то и следить за стыками.",
    author: "Дмитрий Л.",
    role: "Заказчик, нежилое здание 1 300 м²",
  },
  {
    quote: "Для бухгалтерии подготовили полный пакет: договор, акты, исполнительная. Закрывающие пришли вовремя, вопросов от налоговой не было.",
    author: "Елена С.",
    role: "Финансовый директор, торговый объект",
  },
  {
    quote: "Ресторан в центре Самары, плотная застройка, всё вручную. Уложились за 5 месяцев — соседи даже не жаловались.",
    author: "Игорь Т.",
    role: "Владелец ресторана, ул. Ленинградская",
  },
];
